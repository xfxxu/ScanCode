...
//        [self showAlertWithTitle:@"扫描结果" message:[[metadataObjects firstObject] stringValue] sureHandler:nil cancelHandler:nil];
        [self showAlertWithTitle:@"扫描结果" message:[[metadataObjects firstObject] messageString] sureHandler:^{
            NSLog(@"%@",[[metadataObjects firstObject] messageString]);
        } cancelHandler:^{
            //停止扫描
            [self stopScanning];
        }];
...
//            [self showAlertWithTitle:@"扫描结果" message:[[features firstObject] messageString] sureHandler:nil cancelHandler:nil];
            [self showAlertWithTitle:@"扫描结果" message:[[features firstObject] messageString] sureHandler:^{
                NSLog(@"%@",[[features firstObject] messageString]);
            } cancelHandler:^{
                //停止扫描
                [self stopScanning];
            }];
